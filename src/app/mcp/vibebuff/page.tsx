...
export default function VibebuffMcpPage() {
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 relative">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-6 leading-relaxed">
              ...
              <span className="text-primary font-medium"> Never leave your IDE to research tools again.</span>
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground font-heading mb-4">
              Why Engineering Teams Use VibeBuff MCP
            </h2>
