...
// GAME CENTER - COMMENTED OUT FOR NOW
...
export default function PlayPage() {
  return (
    <div className="min-h-screen bg-[#000000] flex items-center justify-center">
      <PixelCard className="p-8 text-center max-w-md">
        <Construction className="w-12 h-12 mx-auto mb-4 text-[#3b82f6]" />
        <p className="text-[#60a5fa] text-sm mb-2">GAME CENTER</p>
  ...
  // ORIGINAL GAME CENTER CODE BELOW
